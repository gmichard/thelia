...
(15, 'currency_rate_update_url', 'http://www.ecb.int/stats/eurofxref/eurofxref-daily.xml', 0, 0, NOW(), NOW()),
(16, 'page_not_found_view', '404.html', 0, 0, NOW(), NOW()),
(17, 'obsolete_rewriten_url_view', 'obsolete-rewritten-url', 0, 0, NOW(), NOW()),
(18, 'use_tax_free_amounts', 0, 0, 0, NOW(), NOW()),
(19, 'process_assets', '0', 0, 0, NOW(), NOW()),
(20, 'thelia_admin_remember_me_cookie_name', 'tarmcn', 0, 0, NOW(), NOW()),
(21, 'thelia_admin_remember_me_cookie_expiration', 2592000, 0, 0, NOW(), NOW()),
(22, 'thelia_customer_remember_me_cookie_name', 'tcrmcn', 0, 0, NOW(), NOW()),
(23, 'thelia_customer_remember_me_cookie_expiration', 31536000, 0, 0, NOW(), NOW()),
(24, 'url_site','', 0, 0, NOW(), NOW()),
(25, 'pdf_invoice_file', 'invoice', 0, 0, NOW(), NOW()),
(26, 'pdf_delivery_file', 'delivery', 0, 0, NOW(), NOW()),
(27, 'unknown-flag-path','assets/img/flags/unknown.png', 0, 0, NOW(), NOW()),
(28, 'html_output_trim_level','1', 0, 0, NOW(), NOW()),
(29, 'default_available_stock', '100', 0, 0, NOW(), NOW()),
(30, 'information_folder_id', '', 0, 0, NOW(), NOW()),
(31, 'terms_conditions_content_id', '', 0, 0, NOW(), NOW()),
(32, 'allow_negative_stock', '0', 0, 0, NOW(), NOW()),
(33, 'cart.use_persistent_cookie', '1', 0, 0, NOW(), NOW()),
(34, 'cart.cookie_name', 'thelia_cart', 0, 0, NOW(), NOW()),
(35, 'cart.cookie_lifetime', '31536060', 0, 0, NOW(), NOW()),
(36, 'session_config.lifetime', '0', 0, 0, NOW(), NOW()),
(37, 'session_config.default', '1', 1, 1, NOW(), NOW()),
(38, 'default_lang_without_translation', '1', 1, 1, NOW(), NOW()),
(39, 'store_name','', 0, 1, NOW(), NOW()),
(40, 'store_description','', 0, 1, NOW(), NOW()),
(41, 'store_email','', 0, 1, NOW(), NOW()),
(42, 'store_notification_emails','', 0, 1, NOW(), NOW()),
(43, 'one_domain_foreach_lang','0', 1, 1, NOW(), NOW()),
(44, 'thelia_version','2.2.0-alpha1', 1, 1, NOW(), NOW()),
(45, 'thelia_major_version','2', 1, 1, NOW(), NOW()),
(46, 'thelia_minus_version','2', 1, 1, NOW(), NOW()),
(47, 'thelia_release_version','0', 1, 1, NOW(), NOW()),
(48, 'thelia_extra_version','alpha1', 1, 1, NOW(), NOW()),
(49, 'front_cart_country_cookie_name','fcccn', 1, 1, NOW(), NOW()),
(50, 'front_cart_country_cookie_expires','2592000', 1, 1, NOW(), NOW()),
(51, 'sitemap_ttl','7200', 1, 1, NOW(), NOW()),
(52, 'feed_ttl','7200', 1, 1, NOW(), NOW()),
(53, 'form_firewall_bruteforce_time_to_wait', '10', 0, 0, NOW(), NOW()),
(54, 'form_firewall_time_to_wait', '60', 0, 0, NOW(), NOW()),
(55, 'form_firewall_bruteforce_attempts', '10', 0, 0, NOW(), NOW()),
(56, 'form_firewall_attempts', '6', 0, 0, NOW(), NOW()),
(57, 'form_firewall_active', '1', 0, 0, NOW(), NOW()),
(58, 'allow_slash_ended_uri', '1', 0, 0, NOW(), NOW()),
(59, 'error_message.show', '1', 0, 0, NOW(), NOW()),
(60, 'error_message.page_name', 'error.html', 0, 0, NOW(), NOW()),
(61, 'customer_change_email', '0', 0, 0, NOW(), NOW()),
(62, 'customer_confirm_email', '1', 0, 0, NOW(), NOW()),
(63, 'form.secret', 'ThisIsNotASecret', 0, 0, NOW(), NOW())
;
...
INSERT INTO `config_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (61, 'en_US', 'Allow customers to change their email. 1 for yes, 0 for no', NULL, NULL, NULL),
    (62, 'en_US', 'Ask the customers to confirm their email, 1 for yes, 0 for no', NULL, NULL, NULL),
    (63, 'en_US', 'Secret key for form CSRF token', NULL, NULL, NULL),
    ...
    (61, 'fr_FR', 'Permettre aux utilisateurs de changer leur email. 1 pour oui, 0 pour non', NULL, NULL, NULL),
    (62, 'fr_FR', 'Demander aux clients de confirmer leur email. 1 pour oui, 0 pour non', NULL, NULL, NULL),
    (63, 'fr_FR', 'Clé secrète pour le jeton CSRF des formulaires', NULL, NULL, NULL)
;
